...
namespace _02_MVCHoca.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(UrunDbContext context)
        {
            _context = context;
        }
        ...
        {
            var urunDbContext = _context.Urunler.Include(u => u.Kategori);
            return View(await urunDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("UrunID,UrunAdi,Fiyat,Resim,Aciklama,KategoriID")] Urun urun)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UrunID,UrunAdi,Fiyat,Resim,Aciklama,KategoriID")] Urun urun)
        {
            if (id != urun.UrunID)
            {
                return NotFound();
